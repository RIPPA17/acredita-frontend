...
function dataFor(role: Role, stage: Stage) {
  ...
  return {
    ...
    requirements: [
      { id: REQ_COMPANY, project_id: PROJECT, integration_key: 'f30_sii_mes_vigente', name: 'Certificado de Cumplimiento de Obligaciones Laborales y Previsionales (F30-1)', category: 'Laboral', target: 'empresa', is_required: true, frequency: 'mensual', validity_days: 30, alert_days: 7, criticality: 'bloquea_pago', is_active: true, sort_order: 1, description: 'Cumplimiento laboral y previsional', review_checklist: [], applicability: { categories: [] }, blocks_work: false, blocks_assignment: false, service_id: null, due_days: 5 },
