...
-- Separate F30-1 from F30 in the reusable catalog.
...
values ('f30','Certificado de Antecedentes Laborales y Previsionales (F30)','Laboral','empresa',true)
...
-- Normalize names of requirements already assigned to projects.
