...
-- 1) Reingresos: conservar periodos historicos y permitir solo una asignacion activa por acreditacion/trabajador.
...
-- 2) Auditoria de cambios de ficha/contrato del trabajador.
...
-- 3) Estado derivado: ficha incompleta, ausencia de requisitos aplicables y contrato vencido nunca habilitan.
