...
import MandanteAccessConfig from './configuracion/MandanteAccessConfig';
import PlantillasSupabaseConfig from './configuracion/PlantillasSupabaseConfig';
import PrivacyAdminConfig from './configuracion/PrivacyAdminConfig';

type Tab = 'general' | 'solicitudes' | 'accesos' | 'plantillas' | 'privacidad';

const TABS: Array<{ id: Tab; label: string }> = [
  { id: 'general', label: 'General' },
  { id: 'solicitudes', label: 'Solicitudes de acceso' },
  { id: 'accesos', label: 'Accesos Mandante' },
    ...
    <div className="fade-in">
      <div className="relative overflow-hidden bg-gradient-to-br from-navy to-navy-2 px-8 py-4 pb-12 -mx-8 -mt-6">
        <div className="max-w-[1200px] mx-auto">
          ...
          <p className="text-[13.5px] text-gray-300 mt-1.5 max-w-[650px]">Parámetros operativos, onboarding de clientes, catálogo base de requisitos y gobierno de privacidad.</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-cream3 shadow-sm overflow-hidden">
          ...
          <div className="p-5">
            {tab === 'general' ? (
              ...
              <MandanteAccessConfig showToast={showToast} />
            ) : tab === 'privacidad' ? (
              <PrivacyAdminConfig showToast={showToast} />
            ) : loadingPlantillas ? (
