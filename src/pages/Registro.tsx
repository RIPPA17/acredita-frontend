      ...
      <div className="w-full max-w-[560px] overflow-hidden rounded-2xl border border-cream3 bg-white shadow-xl">
        ...
        {enviado ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 p-7">
            ...
            <Field label="Nombre completo"><input required value={form.nombre} onChange={event => update('nombre', event.target.value)} className="form-input w-full" placeholder="Tu nombre" maxLength={120} /></Field>
            <Field label="Empresa o razón social"><input required value={form.empresa} onChange={event => update('empresa', event.target.value)} className="form-input w-full" placeholder="Nombre de la empresa" maxLength={180} /></Field>
            <Field label="RUT"><input required value={form.rut} onChange={event => update('rut', event.target.value)} className="form-input w-full" placeholder="76.123.456-7" maxLength={32} /></Field>
            ...
            <Field label="Correo"><input required type="email" value={form.correo} onChange={event => update('correo', event.target.value)} className="form-input w-full" placeholder="tu@empresa.cl" maxLength={320} /></Field>
            <Field label="Teléfono"><input type="tel" value={form.telefono} onChange={event => update('telefono', event.target.value)} className="form-input w-full" placeholder="+56 9 XXXX XXXX" maxLength={40} /></Field>
